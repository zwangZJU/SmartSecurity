package com.wzlab.smartsecurity.activity.camera.playback.querylist;
...
import com.wzlab.smartsecurity.activity.camera.playback.RemoteListUtil;
...
import com.wzlab.smartsecurity.widget.MySectionIndexer;
...
public class SectionListAdapter implements ListAdapter, OnItemClickListener, PinnedHeaderAdapter, SectionIndexer,
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            holder = new Holder();
            convertView = inflater.inflate(R.layout.layout_item_section_list, null);
            holder.header = (TextView) convertView.findViewById(R.id.header);
            holder.mIvCircle = convertView.findViewById(R.id.timeline_sel_image);
        ...
        if (fileEx.isMore()) {
            ...
            convertView.findViewById(R.id.timeline_sel_image).setVisibility(View.GONE);
            ...
            if (isEdit) {
                ...
                holder.moreBtn.setTextColor(inflater.getContext().getResources().getColor(R.color.colorPrimary));
            ...
            convertView.findViewById(R.id.timeline_sel_image).setVisibility(View.VISIBLE);
