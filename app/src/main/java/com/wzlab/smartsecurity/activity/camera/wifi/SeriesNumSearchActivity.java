package com.wzlab.smartsecurity.activity.camera.wifi;
...
public class SeriesNumSearchActivity extends RootActivity implements OnClickListener/*, OnAuthListener*/ {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSerialNoStr = intent.getStringExtra("deviceSerial");
     ...
     //  mWaitDlg.show();
        ...
        new Thread(){
           ...
           public void run() {
                super.run();
               mEZProbeDeviceInfo = EZOpenSDK.getInstance().probeDeviceInfo(mSerialNoStr,mDeviceType);
              Message message = new Message();
              message.what = MSG_LOAD_CAMERA_INFO_SUCCESS;
...
//        mDeviceIcon.setImageResource(getDeviceIcon(""));
    ...
    public void showUnbind() {
        showCameraList();
        mTvStatus.setVisibility(View.VISIBLE);
        mTvStatus.setTextColor(getResources().getColor(R.color.black1));
    ...
    private void showInputCameraPswDlg() {
        ...
        final View passwordErrorLayout = factory.inflate(R.layout.layout_password_error, null);
    ...
    private void addQueryCameraAddVerifyCode() {
        ...
        new Thread() {
            public void run() {
                ...
                try {
                    boolean result = SmartSecurityApplication.getOpenSDK().addDevice(mSerialNoStr, mVerifyCode);
...
//        }
    ...
    private void showWifiConfig() {
        ...
        mAddButton.setVisibility(View.GONE);
        mTvStatus.setTextColor(getResources().getColor(R.color.colorPrimary));
    ...
    private void showInputCameraVerifyCodeDlg() {
        ...
        // 从布局中加载视图
        LayoutInflater factory = LayoutInflater.from(SeriesNumSearchActivity.this);
        final View passwordErrorLayout = factory.inflate(R.layout.layout_verifycode, null);
        final EditText newPassword = (EditText) passwordErrorLayout.findViewById(R.id.new_password);
