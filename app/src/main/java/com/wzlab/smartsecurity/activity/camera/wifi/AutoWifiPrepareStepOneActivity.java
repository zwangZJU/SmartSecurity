...
import com.wzlab.smartsecurity.widget.BoldSpan;
...
public class AutoWifiPrepareStepOneActivity extends RootActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_auto_wifi_prepare_step_on);
        initTitleBar();
        initUI();
    }
    ...
    private void initUI() {
        ...
        spanStr.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.white_top)), 12, 14,
