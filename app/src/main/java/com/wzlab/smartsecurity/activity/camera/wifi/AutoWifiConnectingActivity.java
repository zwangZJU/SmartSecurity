...
//    private UnbindDeviceTriggerHelper mTriggerHelper;
    ...
    private int probeDeviceInfo(String deviceSerial) {
        mEZProbeDeviceInfo = SmartSecurityApplication.getOpenSDK().probeDeviceInfo(serialNo,deviceType);
...
//        mTriggerHelper.onActivityResult(requestCode, resultCode, intent);
    ...
    private void start() {
       ...
       if(support_Wifi && support_sound_wave){
        ...
        SmartSecurityApplication.getOpenSDK().stopConfigWiFi();
        SmartSecurityApplication.getOpenSDK()
        ...
        new Thread() {
            public void run() {
                ...
                while (count > 0) {
                    ...
                    try {
                        SmartSecurityApplication.getOpenSDK().addDevice(serialNo, mVerifyCode);
